...
```{r}
scatterplot_G3 <- ggplot(exercise_combine, aes(x = age, y = G3.x, color = sex)) + geom_point() + geom_jitter(width = 0.1, alpha = 0.3) + labs(title = "Scatterplot of G3 and Age by Sex", x = "Age", y = "G3")
scatterplot_G3 
```

```{r}
scatterplot_G3 <- ggplot(exercise_combine, aes(x = failures, y = G3.x, color = school)) + geom_point() + geom_jitter(width = 0.1, alpha = 0.3) + labs(title = "Scatterplot of G3 and Failures by School", x = "Failures", y = "G3")
scatterplot_G3 
```
